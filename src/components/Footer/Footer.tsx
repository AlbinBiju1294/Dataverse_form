...
const Footer = ({handleNextClick,activeStep,setActiveStep,completed,setCompleted,handleBack}:{handleNextClick:any,activeStep:any,setActiveStep:any,completed:any,setCompleted:any,handleBack:any}) => {
  ...
  return (
    <footer className=" fixed flex justify-center items-center w-[100%] h-[10vh] bg-white z-[998] bottom-0">
      <div className=" border-t border-[#1976d2] w-[65%] h-[100%] flex items-center justify-between">
        <Button onClick={handleBack} variant="outlined" size="small" startIcon={<ArrowBackIcon />}>
          Previous
        </Button>
